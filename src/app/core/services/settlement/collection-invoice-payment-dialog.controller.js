(function () {
  ...
  angular
    ...
    .controller('CollectionInvoicePaymentDialogController', CollectionInvoicePaymentDialogController);

  CollectionInvoicePaymentDialogController.$inject = ['member', 'invoices', '$q', 'lookupService', 'PricingService', 'SettlementService', '$uibModalInstance'];
  /* ngInject */
  function CollectionInvoicePaymentDialogController(member, invoices, $q, lookupService, PricingService, SettlementService, $uibModalInstance) {
    var vm = this;
    vm.member = member;
    vm.invoices = invoices;
    vm.ok = ok;
    vm.cancel = cancel;
    vm.title = 'Collection Invoices Payment';
